			...
			<div class="row">	
				<div class="col-12 col-md-6 col-lg-4">
					<table>
						<tr>
							<td>
								<img src="assets/logo-single-white.png" height="60" width="150">
							</td>
					...
					<table style="font-size: 12px; color: #fff;">
						<tr>
							...
							<td class="pl-1">
								<span><a href="mailto:ragav@npoca.com">ragav@npoca.com</a></span>
							</td>
						</tr>
					</table>
				...
				<div class="col-12 col-md-6 col-lg-4 my-auto mx-auto">
					<br>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="mail-form show-form">
						...
						<form id="mf-1" class="mform">
							...
							<br>
							<button type="submit" id="mf-btn" class="mf-but">
